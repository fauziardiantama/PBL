...
@section('title', 'Seminar dan revisi')
@section('path')
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li class="breadcrumb-item active">Seminar dan revisi</li>
@endsection
@section('content')
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                      <a href="{{ '/dosen/seminardanrevisi/' . $m->id_magang }}" class="btn btn-primary btn-sm">

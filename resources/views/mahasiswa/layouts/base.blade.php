...
<head>
    ...
    <title>@yield("title") Mahasiswa - SIMKMM | Sistem Informasi Kegiatan Magang Mahasiswa D3 Teknik Informatika UNS</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #FED700">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ url('/mahasiswa/dashboard') }}" class="nav-link  text-dark">Dashboard</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                        ...
                        <li class="user-body">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <a href="{{ url('/mahasiswa/profil') }}">Profile</a>
                                </div>
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4"
            ...
            <!-- Brand Logo -->
            <a href="{{ url('/mahasiswa/dashboard') }}" class="brand-link text-white" style="border-color: black;">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="{{ url('/mahasiswa/dashboard') }}" class="nav-link text-white {!! request()->is('mahasiswa/dashboard*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/mahasiswa/magang') }}" class="nav-link text-white {!! request()->is('mahasiswa/magang*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        {{-- <li class="nav-item">
                            <a href="{{ url('/mahasiswa/bimbingan') }}" class="nav-link text-white {!! request()->is('mahasiswa/bimbingan*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/mahasiswa/seminar') }}" class="nav-link text-white {!! request()->is('mahasiswa/seminar*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/mahasiswa/revisi') }}" class="nav-link text-white {!! request()->is('mahasiswa/revisi*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                                <i class="nav-icon fas fa-chalkboard-teacher"></i>
                                <p>
                                    Revisi
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/mahasiswa/nilai') }}" class="nav-link text-white {!! request()->is('mahasiswa/nilai*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/mahasiswa/profil') }}" class="nav-link text-white {!! request()->is('mahasiswa/profil*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">

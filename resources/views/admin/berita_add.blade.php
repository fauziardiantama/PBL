...
<form action="{{ url('admin/berita/'.$b->id_berita) }}" method="post">
    ...
    <div class="col-lg-8">
        ...
        <div class="card-body p-0">
            <textarea class="mailbox-read-message @error('deskripsi') is-invalid @enderror" name="deskripsi">{{ old('deskripsi') }}</textarea>
            @error('deskripsi')
    ...
    <div class="col-lg-4">
        ...
        <div class="card-body">
            ...
            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ old('judul') }}" placeholder="Masukkan Judul">
            @error('judul')
            <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
            </span>
            ...
            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug') }}" placeholder="Masukkan slug">
            @error('slug')
            <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
            </span>

...
<head>
    ...
    <title>@yield('title') Admin - SIMKMM | Sistem Informasi Kegiatan Magang Mahasiswa D3 Teknik Informatika UNS</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #FED700">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ url('/admin/dashboard') }}" class="nav-link  text-dark">Dashboard</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user user-menu">
                    <a href="#" class="nav-link dropdown-toggle  text-dark" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">Admin KMM</span>
                    </a>
                        ...
                        <li class="user-body">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <a href="{{ url('/admin/profil') }}">Profile</a>
                                </div>
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4"
            ...
            <!-- Brand Logo -->
            <a href="{{ url('/admin/dashboard') }}" class="brand-link text-white" style="border-color: black;">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="{{ url('/admin/dashboard') }}" class="nav-link text-white {!! request()->is('admin/dashboard*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/tahun') }}" class="nav-link text-white {!! request()->is('admin/tahun*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/topik-kmm') }}" class="nav-link text-white {!! request()->is('admin/topik-kmm*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/informasi-kmm') }}" class="nav-link text-white {!! request()->is('admin/informasi-kmm*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                                <i class="nav-icon fas fa-file"></i>
                                <p>
                                    Dokumen Informasi KMM
                                </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/admin/instansi') }}" class="nav-link text-white {!! request()->is('admin/instansi*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/progres') }}" class="nav-link text-white {!! request()->is('admin/progres*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/user') }}" class="nav-link text-white {!! request()->is('admin/user*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/berita') }}" class="nav-link text-white {!! request()->is('admin/berita*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/kontak') }}" class="nav-link text-white {!! request()->is('admin/kontak*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/magang') }}" class="nav-link text-white {!! request()->is('admin/magang*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/nilai') }}" class="nav-link text-white {!! request()->is('admin/nilai*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/profil') }}" class="nav-link text-white {!! request()->is('admin/profil*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/logout') }}" class="nav-link text-white {!! request()->is('admin/logout*') ? 'font-weight-bolder" style="outline: 1px solid white;' : ''!!}">

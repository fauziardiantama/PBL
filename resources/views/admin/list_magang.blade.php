...
<div class="row justify-content-between ml-1 mr-1 mb-4">
    <div class="custom-control custom-switch">
      ...
      <input type="checkbox" class="custom-control-input" id="customSwitch" @if(!Request::get('view') || Request::get('view') != 'list') checked @endif/>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                      <a href="{{ '/admin/magang/' . $m->id_magang }}" class="btn btn-primary btn-sm">
              ...
              <div class="col-lg-4">
                      <div class="card card-custom card-margin">
                          ...
                          <div class="widget-49">
                              ...
                              <a href="{{ '/admin/magang/' . $m->id_magang }}" class="btn btn-sm btn-outline-primary">View</a>
                              <form action="{{ '/admin/magang/' . $m->id_magang }}" style="display: contents" method="POST">
                                  @csrf
                                  @method('DELETE')
